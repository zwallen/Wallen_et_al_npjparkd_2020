...
saveRDS(taxa, "../../Script_Output/Dataset1_Output/ASVTaxaSILVA132minBoot80.rds")

#write taxa table
taxa.df <- add_rownames(as.data.frame(taxa), "ASV")
write.table(taxa.df, "../../Script_Output/Dataset1_Output/ASVTaxaSILVA132minBoot80.txt", sep="\t", row.names=F, quote=F)
