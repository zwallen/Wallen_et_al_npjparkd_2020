...
#Results reported in manuscript text and used to generate Figure 3 and Supplementary Figure 1, Dataset 2 cases
date()
...
write.table(case.table, "../Script_Output/Dataset2_Output/SparCC_case_table.txt", row.names=F, quote=F, sep="\t")

cat("\n","SparCC input data created","\n")

#Calculate SparCC correlation matrices
cat("\n","Beginning SparCC correlation calculations","\n")
system("SparCC.py ../Script_Output/Dataset2_Output/SparCC_case_table.txt --cor_file=../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Cases.txt --cov_file=../Script_Output/Dataset2_Output/SparCC_Cov_Matrix_Cases.txt")
cat("\n","Finished","\n")
...
system("mkdir ../Script_Output/Dataset2_Output/SparCC_permutations_case")
system("MakeBootstraps.py ../Script_Output/Dataset2_Output/SparCC_case_table.txt -n 3000 --template=SparCC_case_table_perm#.txt --path=../Script_Output/Dataset2_Output/SparCC_permutations_case/")
cat("\n","Finished","\n")
...
system("cd ../Script_Output/Dataset2_Output/SparCC_permutations_case/; for i in SparCC_case_table_perm*.txt; do SparCC.py $i --cor_file=$i.cor.txt --cov_file=$i.cov.txt; done")
cat("\n","Finished","\n")

#Calculate pseudo-pvalues for SparCC correlations
cat("\n","Beginning pseudo-pvalue calculation for SparCC correlations","\n")
system("PseudoPvals.py ../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Cases.txt ../Script_Output/Dataset2_Output/SparCC_permutations_case/SparCC_case_table_perm#.txt.cor.txt 3000 -o ../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Cases_pvals.txt -t two_sided")
cat("\n","Finished","\n")

system("rm -r ../Script_Output/Dataset2_Output/SparCC_permutations_case")
system("rm ../Script_Output/Dataset2_Output/SparCC_case_table.txt")
