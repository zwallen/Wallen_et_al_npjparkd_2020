...
filtFs <- list.files(filtpath, pattern="_04_R1_001.fastq.gz", full.names=TRUE)
filtRs <- list.files(filtpath, pattern="_04_R2_001.fastq.gz", full.names=TRUE)
...
#Forward
pdf("../../Script_Output/Dataset2_Output/ErrorRatePlotF_04.pdf")
plotErrors(errF, nominalQ=TRUE)
dev.off()
#Reverse
pdf("../../Script_Output/Dataset2_Output/ErrorRatePlotR_04.pdf")
...
saveRDS(seqtab2, "../../Script_Output/Dataset2_Output/seqtab04.rds")
