...
#Used as input to Gephi to create Figure 3 and Supplementary Figure 1, Dataset 2 cases and controls
date()
...
case.cor <- read.table("../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Cases.txt", header = T, row.names = "OTU_id", stringsAsFactors = F)
cont.cor <- read.table("../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Controls.txt", header = T, row.names = "OTU_id", stringsAsFactors = F)
case.p <- read.table("../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Cases_pvals.txt", header = T, row.names = "OTU_id", stringsAsFactors = F)
cont.p <- read.table("../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Controls_pvals.txt", header = T, row.names = "OTU_id", stringsAsFactors = F)
...
#write out files
write.csv(nodes, "../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_nodeTable.csv",
          row.names = F, quote = F)
write.csv(edges.case, "../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Cases_edgeTable.csv",
          row.names = F, quote = F)
write.csv(edges.cont, "../Script_Output/Dataset2_Output/SparCC_Corr_Matrix_Controls_edgeTable.csv",
          row.names = F, quote = F)
