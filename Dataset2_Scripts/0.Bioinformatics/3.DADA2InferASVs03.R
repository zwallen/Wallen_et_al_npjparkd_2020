...
filtFs <- list.files(filtpath, pattern="_03_R1_001.fastq.gz", full.names=TRUE)
filtRs <- list.files(filtpath, pattern="_03_R2_001.fastq.gz", full.names=TRUE)
...
#Forward
pdf("../../Script_Output/Dataset2_Output/ErrorRatePlotF_03.pdf")
plotErrors(errF, nominalQ=TRUE)
dev.off()
#Reverse
pdf("../../Script_Output/Dataset2_Output/ErrorRatePlotR_03.pdf")
...
saveRDS(seqtab2, "../../Script_Output/Dataset2_Output/seqtab03.rds")
