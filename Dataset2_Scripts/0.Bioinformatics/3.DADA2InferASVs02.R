...
filtFs <- list.files(filtpath, pattern="_02_R1_001.fastq.gz", full.names=TRUE)
filtRs <- list.files(filtpath, pattern="_02_R2_001.fastq.gz", full.names=TRUE)
...
#Forward
pdf("../../Script_Output/Dataset2_Output/ErrorRatePlotF_02.pdf")
plotErrors(errF, nominalQ=TRUE)
dev.off()
#Reverse
pdf("../../Script_Output/Dataset2_Output/ErrorRatePlotR_02.pdf")
...
saveRDS(seqtab2, "../../Script_Output/Dataset2_Output/seqtab02.rds")
