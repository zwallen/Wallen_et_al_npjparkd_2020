...
for f in ../../Sequences/Dataset2/5176-HP-Pool_06*
...
do
	...
	do
		...
		-o ../../../Script_Output/Dataset2_Output/PrimerTrimmedSeqs/${FILE_NAME}_06_R1_001.fastq.gz \
		-p ../../../Script_Output/Dataset2_Output/PrimerTrimmedSeqs/${FILE_NAME}_06_R2_001.fastq.gz \
