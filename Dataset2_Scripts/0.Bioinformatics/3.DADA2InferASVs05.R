...
filtFs <- list.files(filtpath, pattern="_05_R1_001.fastq.gz", full.names=TRUE)
filtRs <- list.files(filtpath, pattern="_05_R2_001.fastq.gz", full.names=TRUE)
...
#Forward
pdf("../../Script_Output/Dataset2_Output/ErrorRatePlotF_05.pdf")
plotErrors(errF, nominalQ=TRUE)
dev.off()
#Reverse
pdf("../../Script_Output/Dataset2_Output/ErrorRatePlotR_05.pdf")
...
#Construct initial sequence vairant table
...
saveRDS(seqtab2, "../../Script_Output/Dataset2_Output/seqtab05.rds")
